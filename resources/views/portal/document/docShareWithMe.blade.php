	...
	<div class="col-md-12" style="">
		<div class="col-md-12 search-top-section">
			...
			<div class="col-md-4 ">
				...
				<a class="btn btn-success pull-right" style="margin-top: 8px;margin-right: 10px;"  href="{{route('documentManagemet.index')}}">Upload Document</a>
			</div>
		</div>
	</div>
</div>
							...
							<div class="box box-primary">
								...
								@endswitch
	             				...
	             				<div class="btn-group" style="    width: 100%;">
	                      			...
	                      			<a type="button" class="btn btn-primary" href="{{url('public/storage/uploads/document')}}/{{$docs->doc_file}}" target="_blank" download style="width:30%;display:inline-block;background-color: #013366;border-color: #013366;"><i style="size: 24px;" class="fa fa-download"></i></a>
	                    		</div>
	                    	</div>
                    	</div>
          			</div>
