    ...
    <div class="row">
            ...
            <div class="small-box bg-green">
                <div class="inner">
                    <div class="inner-box" style="background-color: #ecb442;">
                        ...
                        <a href="{{route('getNotification')}}">GetNotify</a>
                    </div>
                ...
                <a href="{{route('companyemployee')}}" class="small-box-footer" style="font-size:14px;color: black;">More
                    info
        ...
        <div class="col-lg-4 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{ route('projects.index') }}" class="small-box-footer" style="font-size:14px;color: black;">More
                    info
                        ...
                        @if($count < 5)
                            ...
                            @foreach($companies as $data)
                                ...
                                <tr style="font-size: 11px;">
                                    <td>{{ $count}}</td>
                                    <td>
                                        <a href="{{route('companyShow',[base64_encode($data->id)])}}">{{ucfirst($data->Client_name)}}</a>
                                    </td>
                        ...
                        @if($count < 5)
                            @foreach($employee_list as $data)
                                ...
                                <tr style="font-size:11px;">
                                    <td>{{$count}}</td>
                                    <td>
                                        <a href="{{route('companyemployeeInfoEdit',[$data->id])}}">{{ucfirst($data->first_name)}} {{ucfirst($data->last_name)}}</a>
                                    </td>
                                    <td>{{$data->phone}}</td>
