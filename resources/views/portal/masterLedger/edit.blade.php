...
<div class="row">    
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-plus"></i> Edit Master Ledger</h3></div>
                                ...
                                <div class="card-body"> 
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" required="" name="client_id" id="get_client_list_by_client">
                                                    ...
                                                    <option value="{{$clientType->id}}" {{$masterLedger->relationship_id == $clientType->id  ? 'selected' : ''}}>{{$clientType->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="number" name="opening_balance" placeholder="Opening Balance" required="" value="{{$masterLedger->opening_balance}}" step="any" autocomplete="off" id="opening_balance">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Closing Balance&nbsp;<span style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="number" name="closing_balance" placeholder="Closing Balance" readonly="" value="{{$masterLedger->closing_balance}}" step="any" autocomplete="off" id="closing_balance">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">As On Date&nbsp;<span style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control datepicker" name="as_on_date" value="{{$masterLedger->closing_balance_date}}" placeholder="As On Date" type="text" required="" id="as-on-date" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
