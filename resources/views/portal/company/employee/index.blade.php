    ...
    <div class="row">
        <div class="col-md-12">
            <div class="content-section">
                <div><a href="{{route('companyemployeeCreate')}}">
                        <button class="btn btn-primary "><i class="fa fa-user-plus" aria-hidden="true" title="New"
                                                            style="padding-top: 5px;padding: 4px;"></i>Add
                        </button>
                    </a><br><br></div>
                    ...
                    <table class="table table-bordered main-table search-table ">
                        ...
                        @foreach($employee_list as $list_value)
                            <tr>
                                ...
                                <td>{{$i++}}</td>
                                <td><a href="{{route('companyemployeeInfoEdit',[$list_value->id])}}">
                                        {{$list_value->first_name}} {{$list_value->last_name}}</a></td>
                                <td>{{$list_value->getUserDetails->email}}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route('employee.permission',[$list_value->id])}}"><i
                                                            class="fa fa-key"></i>Permission</a></li>
                                            <li><a href="{{route('companyemployeeInfoEdit',[$list_value->id])}}"><i
                                                            class="fa fa-edit"></i>Edit</a></li>
                                            <li><a href="{{route('companyemployeeDelete',[$list_value->id])}}"
