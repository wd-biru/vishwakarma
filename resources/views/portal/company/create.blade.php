        ...
        <div class="cardtb">
            <div class="tabshorizontal">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-plus"></i>  <span>Create New Company</span></a></li>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <div class="row">
                            <form class="form-horizontal" action="{{route('companyStore')}}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                    <input class="form-control" type="text" name="Company_name" id="Company_name" placeholder="Enter full name" style="text-transform: capitalize" value="{{old('Company_name')}}" required="">
                                                </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-4">Registration NO.&nbsp;<span style="color: #f70b0b">*</span></label>
                                                    <div class="col-md-8">
                                                    <input class="form-control" type="text" value="{{old('reg_no')}}" name="Registration_No" id="reg_no" placeholder="HE 1117" required>
                                                </div>
                                                </div>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                    <input class="form-control" type="text" value="{{old('Website')}}" name="Website" id="Website" placeholder="https://www.google.com">
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control datepicker" name="Date_Acquired" value="{{old('Date_Acquired')}}" placeholder="Date Acquired" ="" type="text" required="">
                                                </div>
                                                </div>
