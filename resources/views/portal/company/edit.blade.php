        ...
        <div class="cardtb">
            <div class="tabshorizontal">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-plus"></i>  <span><strong>Edit : {{$client->Client_name}} </strong></span></a></li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                    <input class="form-control" type="text" name="Company_name" id="Company_name" placeholder="Enter full name" style="text-transform: capitalize" value="{{$client->Client_name}}" required="">
                                                </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                    <input class="form-control" type="text" value="{{$client->Registration_No}}" name="Registration_No" id="reg_no" placeholder="HE 1117" required>
                                                </div>
                                                </div>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                      ...
                                                      <input class="form-control" type="text" value="No Website Registered" name="Website" id="Website" placeholder="https://www.google.com">
                                                      @else
                                                    <input class="form-control" type="text" value="{{$client->Website}}" name="Website" id="Website" placeholder="https://www.google.com">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control datepicker" name="Date_Acquired" value="{{$client->Date_Acquired}}" placeholder="Date Acquired"  type="text" required="">
                                                      @else
                                                    <input class="form-control datepicker" name="Date_Acquired" value="{{$client->Date_Acquired}}" placeholder="Date Acquired"  type="text" required="">
                                                    @endif
                                                </div>
