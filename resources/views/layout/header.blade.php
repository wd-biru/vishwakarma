    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="top-nav pull-right" style="height: 25px;">
          <li class="dropdown">
            <a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="    margin-top:34px;  ">
...
?>
  @if($imgdata!=null && getAdminImageUrl($imgdata->image_name))
    <img src="{{getAdminImageUrl($imgdata->image_name)}}" class="img-circle" style="" alt="User Image"/>
  @else
        ...
        <a style="color: white; font-size:15px;" href="{{route('admin.profile')}}">
            ...
            <!-- <small>{{ucfirst(Auth::user()->user_type)}}</small> -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" class="btn" data-toggle="modal" data-target="#ChangePassword" style="color:#fff"><i class="fa fa-key"></i> Change Password</a>
                </div>
                <div class="pull-right">
                  <a href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn" style="color:#fff">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" >
          <form class="form-horizontal" action="{{route('login.passwordChange')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group">
              <label class="control-label col-md-4">Email&nbsp;<span style="color: #f70b0b">*</span></label>
              <div class="col-md-8">
                <input class="form-control" type="text" value="{{Auth::user()->email}}" name="email"  placeholder="xxxxx@xxx.com" >
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-4">Password</label>
              <div class="col-md-8">
                <input class="form-control" id="password" type="password" value="{{Auth::user()->password}}" autocomplete="off" class="effect-2" name="password" placeholder="Password" required>
              </div>
            </div>
        </div>
