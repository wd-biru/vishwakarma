    ...
    <div class="page-title">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li><a href="#">{{$portal_edit_values->company_name}}</a></li>
            </ul>
        </div>
    </div>
@endsection
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                             ...
                                             <legend>Portal</legend>
                                                    <input type="hidden" name="update_id" id="oprate_id" value="{{$portal_edit_values->id}}">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <fieldset><br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                        <input autocomplete="new-password" class="form-control" type="text" value="{{$data->email}}" name="email" id="email" placeholder="xxxxx@xxx.com" >
                                                    </div>
                                                    </div>
                                                    <div class="form-group">
...
@if($portal_edit_values->logo_img)
          <img  id="output" style="height: 168px; width: 100%; " src="{{ my_asset('uploads/portal_images/'.$portal_edit_values->logo_img)}} " alt="" title="your Logo" class=" img-thumbnail" required></div>
@else
<img  id="output" style="height: 168px; width: 100%; " src="{{ my_asset('uploads/portal_images/default.jpg')}} " alt="" title="your Logo" class=" img-thumbnail" required></div>
