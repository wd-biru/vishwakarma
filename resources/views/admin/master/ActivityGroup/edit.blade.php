        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @include('includes.validation_messages')
                    ...
                    <form class="form-horizontal" action="{{route('activityGroup.update',[$activityGroup->id])}}" method="post" enctype="multipart/form-data"> 
                        {{ csrf_field() }}
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body"> 
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" placeholder="Enter Group Name" name="group_name" required="" value="{{$activityGroup->activity_group}}">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <div class="form-group">
