...
<div class="row">    
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-plus"></i>Edit Micro Activity Work</h3></div>
            <div class="panel-body">
                @include('includes.msg')
                @include('includes.validation_messages')

                    <form class="form-horizontal" action="{{route('microAcivity.update',$microActivity->id)}}" method="post" enctype="multipart/form-data"> 
                                ...
                                <div class="card-body"> 
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select name="activity_group_id" id="activity_group_id" class="form-control" required="">
                                                    ...
                                                    <option value="{{$activityGroup->id}}" @if($activityGroup->id == $microActivity->activity_group_id) ? selected : '' @endif>{{$activityGroup->activity_group}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select name="sub_activity_id" id="sub_activity_id" class="form-control" required="">
                                                    ...
                                                    @foreach($subActivityWorks as $subActivity)
                                                    <option value="{{$subActivity->id}}" @if($subActivity->id == $microActivity->sub_activity_work_id) ? selected : '' @endif>{{$subActivity->sub_activity_work}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" placeholder="Sub Activity Work" name="micro_activity_name" required="" value="{{$microActivity->micro_activity_work}}">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <div class="form-group">
