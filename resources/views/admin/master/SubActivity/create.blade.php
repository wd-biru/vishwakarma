        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @include('includes.validation_messages')
                    ...
                    <form class="form-horizontal" action="{{route('subActivity.store')}}" method="post" enctype="multipart/form-data"> 
                        {{ csrf_field() }}
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body"> 
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" placeholder="Sub Activity Work" name="sub_activity_name" required="">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <div class="form-group">
