...
<div class="row">    
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-plus"></i> Edit Bank Info</h3></div>
            <div class="panel-body">
                @include('includes.msg')
                @include('includes.validation_messages')

                    <form class="form-horizontal" action="{{route('bankMaster.update',[$bankmaster->id])}}" method="post" enctype="multipart/form-data"> 
                        {{ csrf_field() }}
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body"> 
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="bank_name"  placeholder="Bank Name" required=""  value="{{ $bankmaster->bank_name}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="ifsc_code" placeholder="IFSC Code" required=""  value="{{ $bankmaster->ifsc_code}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Pincode&nbsp;<span style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="number" name="pincode" id="pincode" placeholder="Pincode" required="" value="{{ $bankmaster->pincode}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Address&nbsp;<span style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <textarea class="form-control" name="address" placeholder="Enter Address" required="">{{ $bankmaster->address}}</textarea>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="card-body">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="district" placeholder="District" required="" value="{{ $bankmaster->district}}" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">City&nbsp;<span style="color: #f70b0b">*</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="city_name" class="form-control" id="city_name" placeholder="Enter City Name" required="" value="{{ $bankmaster->city}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="state_name" class="form-control" id="state_name" placeholder="Enter State Name"  required="" value="{{ $bankmaster->state}}">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="country_name" id="country_name" placeholder="Enter Country Name" required="" value="{{ $bankmaster->country}}">
