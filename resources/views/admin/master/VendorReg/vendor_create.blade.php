        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="{{route('vendorStore')}}" method="post"
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="name"
                                                       placeholder="Enter  name" style="text-transform: capitalize"
                                                       value="{{old('name')}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Mobile&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="number" value="{{old('mobile')}}"
                                                       name="mobile" id="mobile" placeholder="9931815443"><span
                                                        style="color:green" id="mobile_status"></span>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-4">Director Name&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" value="{{old('director_name')}}"
                                                       name="director_name" id="director_name"
                                                       placeholder="Director Name"><span style="color:green"
                                                                                         id="mobile_status"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Director Number&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="number"
                                                       value="{{old('director_number')}}" name="director_number"
                                                       id="director_number" placeholder="9965285943">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Supplier&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-sm-8">
                                                <select class="form-control" required="" id="supplier_of"
                                                        class="form-control check_value_ea" name="supplier_of[]"
                                                        multiple>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="email" value="{{old('email')}}"
                                                       name="email" id="email" placeholder="xxxxx@xxx.com">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" id="password" type="password"
                                                       class="effect-2" name="password" placeholder="Password" required
                                                       value="{{old('password')}}">
                                            </div>
                                        </div>
                                    </fieldset>
                            ...
                            <div class="card" style="margin-top: 28px;">
                                <div class="card-body">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" required="" id="state"
                                                        class="form-control check_value_ea check_name_ea" name="state">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">State Code&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="state_code"
                                                       id="state_code" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" required="" id="city"
                                                        class="form-control check_value_ea check_name_ea" name="city">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">GSTIN/UIN&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="gstn_uin" id="gstn_uin"
                                                       value="{{old('gstn_uin')}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Pincode&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Mode/Terms Of Payment&nbsp;<span
                                                        style="color: #f70b0b">*</span></label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="mode_payment"
                                                       id="mode_payment" value="{{old('mode_payment')}}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" id="submit_btn" class="btn btn-primary pull-right"><i
