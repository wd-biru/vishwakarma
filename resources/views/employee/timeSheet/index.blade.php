    ...
    <div class="col-md-12 col-sm-12">
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div> <a href="#"  data-toggle="modal" data-target="#basicModal"><button class="btn btn-primary "><i class="fa fa-plus"></i>&nbsp;Add Time Sheet</button></a><br><br>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body tabshorizontal ">
                @if(empty($client_list))
                    <p style="color:red;">Please contact to admin for Client permission</p>
                @endif
                <form action="{{route('employee.timeSheet.store')}}" method="post">
                    {{csrf_field()}}
                    <fieldset>
...
<div class="modal fade" id="edit_time_sheet_model" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body tabshorizontal ">
                <form action="{{route('employee.editTimeSheet')}}" method="post">
...
@else
<center>        
    <font style="color:red;font-size: 14px;">Please contact to Admin for Client permission</font>       
</center>
@endif
@endsection
@section('script')
