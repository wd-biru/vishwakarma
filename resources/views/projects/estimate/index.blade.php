                                        ...
                                        <td>
                                          <div class="dropdown">
                                              ...
                                              <ul class="dropdown-menu" style="margin-right:5px;">
                                                  <li><a href="#"  data-toggle="modal" data-target="#modalGetQuoto_{{$value->id}}"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;Get Quote</a>
                                                  </li> 
...
@foreach($record as $value)
<div class="modal fade" id="modalGetQuoto_{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
