                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" style="margin-right: 215px;">                                     
                                            <li>
                                                <a href="{{route('storeInventory',[$project->id,base64_encode($data->id)])}}"><i class="fa fa-inventory"></i>Stock</a> 
                                            </li>
                                            @if(Auth::user()->user_type != "employee")
                                            <li>
                                                <a href="#"  data-toggle="modal" data-target="#modalStore_{{$data->id}}"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;Store Update</a>  
                                            </li>
                                            @endif 
                                        </ul> 
                                    </div>
...
<div class="modal fade" id="modalStore_{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                 <input type="text" style="margin-bottom: 15px;" class="form-control" name="store_name" value="{{$store}}" readonly="">
                </div>
              </div>
                ...
                <div class="col-md-8" style="margin-bottom: 15px;">
                  <select  class="form-control store_keepers" name="store_keeper_id[]"  multiple="" required="">  
                      @foreach($store_emp_list as $list) 
                          <option value="{{$list->id}}" @if(in_array($list->id,$emp_list)) selected @endif>{{$list->first_name}} {{$list->last_name}}</option> 
                      @endforeach
                  </select>
                </div>
              </div>
