...
@section('content')
        <div class="row">
            ...
            <div class="col-md-7 show-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">&nbsp;Selected Agreement Allocation</h3><br>
                    {!! Form::model($project, ['route' => ['agreementResorurce.store', $project->id], 'method' => 'post' ]) !!}
                    <div class="panel-body">
                        <div class="card col-md-12">
                            <div class="table-responsive">
                                {{ csrf_field() }}
                                ...
                                <div  id="button_submit" >
                                    <button type="submit" style="float: right;" id="submit_button"  class="btn btn-primary">Submit</button>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var str = '<tr id="remove_'+data[0].id+'"><td>' + data[0].material_name + '' +
                            ...
                            '<input type="number" class="maty" name="recovery_rate[]" id="recovery_rate" min="1" required /></td>' +
