...
class StoreController extends Controller
{
  ...
  public function storeUpdate(Request $request,$project_id)
    ...
    public function storeInword(Project $project ,Request $request,$store)
    {
       ...
       return view('projects.store.storeinword',compact('project','inwords_material_group','getprimaryid','inwards_inventory_material_group','store','store_detail'));
  ...
  public function getstoreitemlistinvalter(Project $project,Request $request,$store)
  {
         ...
         $getprimaryid=VishwaStoreInventoryQuantity::where('portal_id',$portal_id)->first();
          ...
          $getTypeName = DB::table('vishwa_store_inventory_qty')
             ...
             ->where('vishwa_store_inventory_qty.store_id','=',$store)
             ->whereDate('vishwa_store_inventory_qty.inward_date','>=',$from_date)
             ->whereDate('vishwa_store_inventory_qty.inward_date','<=',$to_date)
             ->whereNotNull('vishwa_store_inventory_qty.invoice_no')
              ->orderBy('vishwa_store_inventory_qty.inward_date', 'DESC')
             ...
             // dd($getTypeName);
                ...
                $getTypeName = [];
                return view('projects.store.view-alter-inward-list',compact('getTypeName','project','store'));
               }
 ...
 return Response::json(array(
         ...
         if($getprimaryid!=null)
         {
          ...
          $getTypeName = DB::table('vishwa_store_inventory_qty')
             ...
             // dd($getTypeName);
                ...
                $getTypeName = [];
                return view('projects.store.view-alter-outward-list',compact('getTypeName','project','store'));
               }
  ...
  $checkitmInGodown=DB::table('vishwa_store_inventory_qty')
    ...
    public function storeoutward(Project $project ,Request $request,$store)
    {
      ...
      return view('projects.store.storeoutword',compact('project','material_item','store','VishwaProjectTower'));
    ...
    {   
      ...
      return view('projects.store.storecurrentstock',compact('project','store_inventory_material_group','segment','store_id','store','mat_itam_list'));
