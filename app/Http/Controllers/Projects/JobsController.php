...
class JobsController extends Controller
{
    ...
    public function create(Project $project)
    {
        ...
        $workers = EmployeeProfile::where('portal_id',Auth::user()->getPortal->id)->where('status',1)->orderBy('first_name')->get();
    ...
    {
           //dd($req->all());
        Log::info('input data Projects\JobsController@store--:'.print_r($req->all(),true));
