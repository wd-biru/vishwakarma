...
{
    protected $table = 'vishwa_projects';
    ...
    {
        return $this->hasMany(IndentMaster::class,'project_id');
    }

    public function stores()
    {
        return $this->hasMany(VishwaProjectStore::class,'project_id')->groupBy('store_name');
    }

    public function resources()
    {
        return $this->hasMany(ProjectMapping::class,'project_id');
    }

    public function towers()
    {
        return $this->hasMany(VishwaProjectTower::class,'project_id')->groupBy('tower_name');
    }
